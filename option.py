...
class BaseOption(object):
    def __init__(self):
        ...
        self.parser.add_argument('--debug', action='store_true', default=True, help='for checking code')

        self.parser.add_argument('--batch_size', type=int, default=1, help='the number of batch_size')
        self.parser.add_argument('--dataset_name', type=str, default='Cityscapes', help='[Cityscapes]')
